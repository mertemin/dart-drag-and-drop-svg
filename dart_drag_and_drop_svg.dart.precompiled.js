...
Interceptor: {"": "Object;",
  ...
  "%": "DOMError|FileError|MediaError|MediaKeyError|Navigator|NavigatorUserMediaError|PositionError|SQLError|SVGAnimatedLength|SVGAnimatedLengthList|SVGAnimatedNumber|SVGAnimatedNumberList|SVGAnimatedString|SVGMatrix|SVGPoint"
},
...
SvgSvgElement: {"": "GraphicsElement;currentTranslate=", "%": "SVGSVGElement"},
...
["", "dart_drag_and_drop_svg.dart", , O, {
main: function() {
  O.Application$("#app_container");
},

BasicUnit: {"": "Object;canvas,group,body,dragging,dragOffsetX,dragOffsetY,width,height",
  select$1: function(_, e) {
    var mouseCoordinates, t1, t2;
  ...
  get$select: function(_receiver) {
    return new O.BoundClosure$i1(this, O.BasicUnit.prototype.select$1, _receiver, "select$1");
  },
  moveStarted$1: function(e) {
    ...
    if (this.dragging === true) {
      ...
      this.body.setAttribute("transform", "translate(" + H.S(newX) + ", " + H.S(newY) + ")");
    }
  },
  get$moveStarted: function() {
    return new H.BoundClosure$1(this, O.BasicUnit.prototype.moveStarted$1, null, "moveStarted$1");
  },
  ...
  get$moveCompleted: function() {
    return new H.BoundClosure$1(this, O.BasicUnit.prototype.moveCompleted$1, null, "moveCompleted$1");
  },
  getMouseCoordinates$1: function(e) {
    var t1, t2, t3, t4, t5, t6;
    t1 = J.get$client$x(e).x;
    t2 = this.canvas;
...
BasicUnit$: function(canvas, x, y, width, height) {
  var t1 = new O.BasicUnit(canvas, null, null, null, null, null, width, height);
...
Application: {"": "Object;WIDTH,HEIGHT,canvas",
  addNewUnit$1: function(e) {
    var t1, t2, t3, t4, newUnit;
    ...
    if (typeof t1 !== "number")
      throw t1.$sub();
    newUnit = O.BasicUnit$(this.canvas, t2 - t3 / 2, t1 - t4 / 2, t3, t4);
    this.canvas.appendChild(newUnit.group);
  },
  Application$1: function(canvas_id) {
    ...
    H.setRuntimeTypeInfo(t1, [null]);
    t2 = new W._EventStreamSubscription(0, t1._target, t1._eventType, W._wrapZone(new O.Application_closure(this)), t1._useCapture);
    H.setRuntimeTypeInfo(t2, [H.getRuntimeTypeArgument(t1, "_EventStream", 0)]);
    t2._tryResume$0();
  },
  static: {
Application$: function(canvas_id) {
  var t1 = new O.Application(80, 60, null);
...
Application_closure: {"": "Closure;this_0",
  call$1: function(e) {
    return this.this_0.addNewUnit$1(e);
  },
  $is_args1: true
}},
1],
...
function dart_precompiled($collectedClasses) {
  ...
  function BasicUnit(canvas, group, body, dragging, dragOffsetX, dragOffsetY, width, height) {
    this.canvas = canvas;
    this.group = group;
    this.body = body;
  ...
  if (!"name" in BasicUnit)
    BasicUnit.name = "BasicUnit";
  $desc = $collectedClasses.BasicUnit;
  if ($desc instanceof Array)
    $desc = $desc[1];
  BasicUnit.prototype = $desc;
  ...
  function Application(WIDTH, HEIGHT, canvas) {
    this.WIDTH = WIDTH;
    this.HEIGHT = HEIGHT;
    this.canvas = canvas;
  }
  ...
  function Application_closure(this_0) {
    this.this_0 = this_0;
  }
